...
const JOBS = [
  ...
  ['anim', '2:3', 'A luminous horizontal FILMSTRIP / sprite-sheet floating in a dark studio: six glowing frames of a small rounded character mid-RUN, the legs clearly in DIFFERENT alternating stride positions across the frames (one foot forward, then the other), like a real run cycle. A thin cyan scanner-beam sweeps across the strip checking each frame, leaving small glowing checkmarks. Soft motes of light drift through the air around it (atmosphere). Deep navy, dramatic teal-and-gold light, keep a calm dark band across the top for a title. No text, no readable words.'],
];
