...
export const PIPELINE = [
  ...
  { key: 'character', phase: 'make', title: 'Character art — an animated hero',
    sub: ['Studio.Toon rig or generated sheet', '6+ animation states', 'enemies have character too'],
    accept: 'The hero is a `Studio.Toon` rig (or a generated sprite sheet via `tools/art-sprites.mjs`) with 6+ animation states + real personality. Enemies have character too (the cast).' },
