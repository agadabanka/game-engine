...
export const PIPELINE = [
  ...
  { key: 'character', phase: 'make', title: 'Character art — animated hero AND enemies (6-7 states, very smooth)',
    sub: ['hero: 6-7 states (idle/run/jump/fall/land/hurt/cheer)', 'every enemy: 6 states (idle/walk/hurt/hop/happy)', 'generated via tools/art-sprites.mjs (model-sheet conditioned)', 'VERY smooth — Studio.Hero springy squash + breathe + bounce/lean'],
    accept: 'Every actor — the hero AND every enemy — has **6-7 animation states** (`tools/art-sprites.mjs`: hero idle/run/jump/fall/land/hurt/cheer; enemy idle/walk/hurt/hop/happy) and animates **VERY smoothly**: `Studio.Hero` adds a springy squash-and-stretch + idle breathe + run/walk bounce & lean on top, so even few-frame sprites feel fluid. Never a tinted blob; enemies never stuck always-walk.' },
